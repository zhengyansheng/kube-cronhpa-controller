...
import (
	...
	"github.com/zhengyansheng/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "20580dc5.zhengyansheng.com",
	...
	// 启动 web server
	go func(cronManager *controller.CronManager, stopChan chan struct{}) {
		server := controller.NewWebServer(cronManager)
		server.Serve()
	}(cm, stopChan)
